...
namespace CommService
{
    ...
    public class FileHandler : IFileHandler
    {
        ...
        public FileHandler(string startPath)
        {
        ...
        private FileHandler(string path, OS os)
        {
          this.currentPath = path;
          this.os = os;
        }

        public IFileHandler Clone(IPEndPoint peer)
        {
            return new FileHandler(currentPath, os);
        }
