...
namespace CommService
{
    ...
    class Session
    {
        ...
        private static string[] HELLO_TEXT =
        {
            ...
            "Hey ho let's go!",
            "The poor man's FTP server.",
            "Down with this sort of thing, careful now!",
            "That would be an ecumenical matter!",
            "Howdy doodly do, talkie's the name, toasting's the game!",
            "These are close up, those are far away!",
        ...
        private IFileHandler fsHandler;
        ...
        public Session(Socket socket, int bufferSize,
            IAuthHandler authHandler, IFileHandler fileSystemHandler, ILogHandler logHandler)
        {
        ...
        private void Work()
        {
            ...
            try {
                ...
                Respond(220, String.Format("This is MooFTPServer v{0}. {1}", LIB_VERSION, GetRandomText(HELLO_TEXT)));
        ...
        private void ProcessCommand(string verb, string arguments)
        {
            switch (verb) {
                case "SYST":
                {
                    Respond(215, "UNIX emulated by MooFTPServer");
                    break;
                }
                case "QUIT":
                {
